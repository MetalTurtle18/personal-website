---
title: 'On Retroactively Writing Project Logs'
description: 'Keeping active project journals is useful and I wish I did it more'
...
## What am I doing to overcome this from now on?

- Don't start a new project until at least all progress is logged from existing ones
  - This glosses over the issue of having many simultaneous projects. That's something I think is all too familiar to engineers and is something other smart people have written about [todo link some]
  - The point is that if I make a smaller effort to document things before moving on, stuff gets documented!
- Log things as goals are met
  - Again, this assumes I acquire the discipline to set good goals before diving into a project and to stick with them. But if I can do that, this small step helps keep things documented
- Get people interested in my in-progress projects
  - If other people want to know what I'm doing, I will be more motivated to keep good records to share with them in real time. This could be family and friends or, more aspirationally, online strangers
- Lock money behind logging
  - I'll be honest, this is another purely personal discipline one. The idea is that I can't spend money on new parts until I have used and documented the last things I bought

## Dating New Articles for Old Projects

When creating articles for my past projects, I still want them to be sorted chronologically. I struggled for a while on how to deal with this problem. I decided to have three date fields for each article:

- pubDate (required): when the article was published
- updateDate (optional): for if I update an article after initial publishing
- chronoDate (optional): the date that I actually did this project

I'll display the first two on every article in a pretty standard blog way. Then I'll use the chrono date to sort articles, and I'll also display it next to the published date.
